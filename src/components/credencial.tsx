...
export function Credential({ data, onChangeAvatar, onExpandQRCode }: Props) {
    ...
    return (
        ...
        >
            ...
            <View className="bg-black/20 self-stretch items-center pb-6 boreder border-white/10 mx-3 rounded-2xl -mt-5">
                ...
                {data.image
                    ...
                    : (
                        <TouchableOpacity activeOpacity={0.9} className="w-36 h-36 rounded-full -mt-24 bg-gray-400 items-center justify-center" onPress={onChangeAvatar}>
                            <Feather name="camera" colors={colors.green[400]} size={32} />
                        </TouchableOpacity>
                    )}
